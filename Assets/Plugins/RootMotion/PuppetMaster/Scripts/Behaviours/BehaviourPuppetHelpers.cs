...
namespace RootMotion.Dynamics {
	...
	public partial class BehaviourPuppet : BehaviourBase {
		...
		private float GetFalloff(int i, int muscleIndex, float falloffParents, float falloffChildren, float falloffSelf) {
			if (i == muscleIndex) return falloffSelf;
		...
		private float GetFalloff(int i, int muscleIndex, float falloffParents, float falloffChildren, float falloffGroup, float falloffSelf) {
			float falloff = GetFalloff(i, muscleIndex, falloffParents, falloffChildren, falloffSelf);
