...
namespace RootMotion.Dynamics {
	...
	public partial class BehaviourPuppet : BehaviourBase {
		...
		/// </summary>
		public void Boost(int muscleIndex, float immunity, float impulseMlp, float boostParents, float boostChildren, float boostSelf = 1f) {
			hasBoosted = true;
			...
			for (int i = 0; i < puppetMaster.muscles.Length; i++) {
				float falloff = GetFalloff(i, muscleIndex, boostParents, boostChildren, boostSelf);
		...
		/// </summary>
		public void BoostImmunity(int muscleIndex, float immunity, float boostParents, float boostChildren, float boostSelf) {
			hasBoosted = true;
		...
		/// </summary>
		public void BoostImpulseMlp(int muscleIndex, float impulseMlp, float boostParents, float boostChildren, float boostSelf) {
			hasBoosted = true;
