...
namespace RootMotion.Dynamics {
	...
	public partial class PuppetMaster: MonoBehaviour {
		...
		private static Muscle.Group FindGroup(Animator animator, Transform t) {
			...
			if (t == animator.GetBoneTransform(HumanBodyBones.LeftFoot)) return Muscle.Group.LeftFoot;
			if (t == animator.GetBoneTransform(HumanBodyBones.LeftHand)) return Muscle.Group.LeftHand;
			if (t == animator.GetBoneTransform(HumanBodyBones.LeftLowerArm)) return Muscle.Group.LeftArm;
			if (t == animator.GetBoneTransform(HumanBodyBones.LeftLowerLeg)) return Muscle.Group.LeftLeg;
			if (t == animator.GetBoneTransform(HumanBodyBones.LeftUpperArm)) return Muscle.Group.LeftArm;
			if (t == animator.GetBoneTransform(HumanBodyBones.LeftUpperLeg)) return Muscle.Group.LeftLeg;
			if (t == animator.GetBoneTransform(HumanBodyBones.RightFoot)) return Muscle.Group.RightFoot;
			if (t == animator.GetBoneTransform(HumanBodyBones.RightHand)) return Muscle.Group.RightHand;
			if (t == animator.GetBoneTransform(HumanBodyBones.RightLowerArm)) return Muscle.Group.RightArm;
			if (t == animator.GetBoneTransform(HumanBodyBones.RightLowerLeg)) return Muscle.Group.RightLeg;
			if (t == animator.GetBoneTransform(HumanBodyBones.RightUpperArm)) return Muscle.Group.RightArm;
			if (t == animator.GetBoneTransform(HumanBodyBones.RightUpperLeg)) return Muscle.Group.RightLeg;
